...
public:
    ...
    static inline auto create_header(const EHeaderType key, Ref<String> value) -> Header;
    static inline auto create_header(Ref<String> key, Ref<String> value) -> Header;
...
protected:
  ...
  auto HttpCommon::create_header(const EHeaderType key, Ref<String> value) -> HttpCommon::Header
  {
    return Header{header_type_to_string(key), value};
  }

  auto HttpCommon::create_header(Ref<String> key, Ref<String> value) -> HttpCommon::Header
  {
